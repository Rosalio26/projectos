...
<head>
    ...
    <title>Aula de Simbologia da computação</title>
    <link rel="stylesheet" href="./style/lessStyle.css">
    <link rel="stylesheet" href="../../../style/lessStyle.css">
</head>
<body>
    <h1 id="javascript" class="lessThem">Aula de Simbologia da computaçâo</h1>
    ...
    <div class="cnt-less-itm">
        ...
        <div class="itmCenter">
            <button class="btnLesson">Projectos <span class="plusAdd">&plus;</span></button>
        </div>
    </div>
</body>
</html>